...
# Kafka subjects are published through the Confluent compatibility API: the runtime clients
# resolve them by subject name, and that namespace is the registry default group.
