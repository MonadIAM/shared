...
export enum PermissionCode {
    ...
    ORGANIZATION_REVOKE             = "organization.revoke",
    ...
    PROJECT_CHANGE_MANAGER = "project.change_manager",
    ...
    PROJECT_ACCOUNT_ASSIGNMENT_CREATE        = "project_account_assignment.create",
    PROJECT_ACCOUNT_ASSIGNMENT_REVOKE        = "project_account_assignment.revoke",
    ...
    DEPARTMENT_CHANGE_MANAGER = "department.change_manager",
    ...
    TEAM_CHANGE_LEAD   = "team.change_lead",
